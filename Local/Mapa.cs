...
public class Mapa
{
    ...
    private void CriarMapa()
    {
     //locais
        ...
        Local escola = new Local("Escola", "Uma escola estudual, sempre vivída com crianças. Hoje, com os portões abertos e diversos corpos no pátio. Talvez você encontre algo útil.");
        ...
        Local laboratorio = new Local("Laboratório", "O laboratório federal, onde os principais estudos eram feitos. O que ele esconde pode mudar tudo.");   
    }
}